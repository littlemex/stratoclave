...
| パス | 対象読者 | 軸 | 読む |
|---|---|---|---|
| [`usage/small-team`](usage/small-team/scenario_ja.md) ([English](usage/small-team/scenario.md)) | user | cost・perf・quality —— offline + 実 Bedrock `--live` baseline | 3人チームが1つの共有予算プールを使う |
