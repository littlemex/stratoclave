...
|---|---|---|---|
| [`usage/small-team`](usage/small-team/scenario.md) ([日本語](usage/small-team/scenario_ja.md)) | user | cost (runs) · perf (gap) · quality (partial) | A three-person team on one shared budget pool |
