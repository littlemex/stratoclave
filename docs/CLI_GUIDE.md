...
|----------|-------------|
| `<api_endpoint>` | Stratoclave deployment root URL, for example `https://<your-deployment>.cloudfront.net`. Must start with `http://` or `https://`. Do not include `/v1`; the CLI will reject it. |
