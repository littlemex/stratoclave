...
- Stratoclave デプロイメントが `https://<subdomain>.cloudfront.net` の形式 (例: `https://d8b03j8erit4k.cloudfront.net`) の CloudFront URL で HTTPS 越しに到達可能であること。まだない場合は、先に [DEPLOYMENT.md](DEPLOYMENT.md) に従うこと。
...
| フィールド                     | 値 |
| ------------------------- | ----- |
| Gateway base URL          | `https://<your-deployment>.cloudfront.net` (例: `https://d8b03j8erit4k.cloudfront.net`) |
